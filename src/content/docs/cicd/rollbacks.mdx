...
<Diagram file="rollback-revisions.svg" alt="Deployment history of immutable image tags. Pick a prior revision to re-roll the same image in 15 to 30 seconds with no rebuild. Database migrations are not undone." />
