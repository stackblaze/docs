---
title: Deploy Hooks
description: Trigger StackBlaze deployments from any external system. POST to the deployments build API with a personal access token from CircleCI, Jenkins, GitHub Actions, or any custom script.
---
