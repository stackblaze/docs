...
<Diagram file="functions-scale-to-zero.svg" alt="Always-on service replicas stay running, compared with a Knative function that cold-starts on the first request and scales to zero when idle" />
