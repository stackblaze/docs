...
<Diagram file="compose-to-canvas.svg" alt="Compose web, postgres, and redis map onto the canvas as a web service plus managed PostgreSQL and Redis, not DIY datastore containers." />
