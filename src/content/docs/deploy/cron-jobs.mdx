...
<Diagram file="cron-lifecycle.svg" alt="A cron schedule tick starts a fresh container, runs the start command, and exits. Overlapping runs follow Forbid (default skip), Replace (cancel previous), or Allow (run both)." />
