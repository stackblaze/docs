...
<Diagram file="secret-file-mount.svg" alt="An encrypted credential is stored after save, then mounted read-only at a path such as /secrets/gcp-sa.json. It is a file, not an environment variable." />
