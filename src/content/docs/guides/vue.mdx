---
title: Vue
description: Deploy Vue on StackBlaze from GitHub or a Dockerfile.
---

Add a service from your Vue repo. Nixpacks detects **node** from `package.json`. A `Dockerfile` in the service root always wins.
