---
title: Nuxt
description: Deploy Nuxt on StackBlaze from GitHub or a Dockerfile.
---

Add a service from your Nuxt repo. Nixpacks detects **node** from `package.json`. A `Dockerfile` in the service root always wins.
