---
title: Symfony
description: Deploy Symfony on StackBlaze from GitHub or a Dockerfile.
---

Add a service from your Symfony repo. Nixpacks detects **php** from `composer.json`. A `Dockerfile` in the service root always wins.
...
Override install / build / start on the service if detection is wrong. Typical start: `php -S 0.0.0.0:$PORT -t public`.
