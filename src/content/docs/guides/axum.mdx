---
title: Axum
description: Deploy Axum on StackBlaze from GitHub or a Dockerfile.
---

Add a service from your Axum repo. Nixpacks detects **rust** from `Cargo.toml`. A `Dockerfile` in the service root always wins.
