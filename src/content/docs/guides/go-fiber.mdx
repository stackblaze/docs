---
title: Go Fiber
description: Deploy Go Fiber on StackBlaze from GitHub or a Dockerfile.
---

Add a service from your Go Fiber repo. Nixpacks detects **go** from `go.mod`. A `Dockerfile` in the service root always wins.
