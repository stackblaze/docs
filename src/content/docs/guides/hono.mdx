---
title: Hono
description: Deploy Hono on StackBlaze from GitHub or a Dockerfile.
---

Add a service from your Hono repo. Nixpacks detects **node** from `package.json`. A `Dockerfile` in the service root always wins.
