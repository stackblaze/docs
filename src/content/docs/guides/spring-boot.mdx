---
title: Spring Boot
description: Deploy Spring Boot on StackBlaze from GitHub or a Dockerfile.
---

Add a service from your Spring Boot repo. Nixpacks detects **java** from `pom.xml or build.gradle`. A `Dockerfile` in the service root always wins.
