---
title: Nest.js
description: Deploy Nest.js on StackBlaze from GitHub or a Dockerfile.
---

Add a service from your Nest.js repo. Nixpacks detects **node** from `package.json`. A `Dockerfile` in the service root always wins.
...
Override install / build / start on the service if detection is wrong. Typical start: `node dist/main.js`.
