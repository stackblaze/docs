...
description: Services in the same project communicate via internal hostnames on a private cluster network. No public internet exposure, no firewall rules.
---
...
![Diagram showing public HTTPS to API and private connections to Postgres and Redis](/illustrations/private-networking.svg)
